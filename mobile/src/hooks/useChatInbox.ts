...
const conversations: Conversation[] = [
    ...
    { id: "6", name: "Alex Kimani", lastMessage: "This is gonna be legendary", time: "2:41 PM", unread: 2 },
    { id: "7", name: "Sarah Wanjiku", lastMessage: "Are we still meeting at Java at 8?", time: "1:15 PM", unread: 0 },
    { id: "8", name: "Nairobi Events Group", lastMessage: "Mike: Anyone going to Blankets & Wine this Sunday?", time: "12:03 PM", unread: 8 },
    { id: "9", name: "Amina", lastMessage: "Just landed! Can't wait to explore", time: "Yesterday", unread: 0 },
    { id: "10", name: "DJ Grauchi", lastMessage: "New mix dropping tonight", time: "Mon", unread: 1 },
];

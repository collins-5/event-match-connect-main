...
import { ActivityIndicator, Pressable, TextProps } from "react-native";
  ...
  "group flex items-center justify-center rounded-md web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructiveoutline: "bg-red-300 border-red-400 web:hover:opacity-90 active:opacity-90",
        outline:
  ...
  "web:whitespace-nowrap text-sm native:text-base font-medium text-foreground web:transition-colors",
  {
    variants: {
      variant: {
        ...
        destructiveoutline: "text-destructive-foreground",
      ...
      >
        {loading ? (
          <ActivityIndicator
            size="small"
            color={
              variant === "default" || variant === "secondary" ? "#fff" : "#000"
            }
          />
        ) : (
          <>
